        ...
        <section className="py-8 sm:py-16 bg-gradient-to-br from-red-50 via-white to-orange-50">
          <div className="container px-12 sm:px-16">
            <div className="mb-6 sm:mb-10 text-center">
              ...
              <p className="mt-2 sm:mt-4 text-xs sm:text-sm text-gray-600 max-w-2xl mx-auto line-clamp-1">
                {description}
              </p>
            </div>
      ...
      <section className="py-8 sm:py-16 bg-gradient-to-br from-red-50 via-white to-orange-50">
        <div className="container px-4 sm:px-16">
          <div className="mb-6 sm:mb-10 text-left">
            <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent uppercase">{title}</h2>
            <p className="mt-2 sm:mt-4 text-xs sm:text-sm text-gray-600 max-w-2xl line-clamp-1">
              {description}
            </p>
          </div>
          ...
          <div className="relative -mx-4 sm:mx-0">
            ...
            >
              <CarouselContent className="-ml-4 sm:-ml-12">
                {packages.map((pkg) => (
                  <CarouselItem key={pkg._id} className="pl-4 sm:pl-12 basis-[85%] sm:basis-[60%] md:basis-[45%] lg:basis-[33.33%]">
              ...
              <CarouselPrevious className="hidden sm:flex -left-24 bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800" />
              <CarouselNext className="hidden sm:flex -right-24 bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800" />
            </Carousel>
          </div>
        </div>
      </section>
